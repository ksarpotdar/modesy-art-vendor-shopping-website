                    ...
                    <div class="col-12">
                        <div class="product-description post-text-responsive">
                            <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab_pre_print_size" data-toggle="tab" href="#tab_pre_print_size_content" role="tab" aria-controls="tab_pre_print_size" aria-selected="false"><?php echo trans("pre_material_options"); ?></a>
                                </li>
                            </ul>
